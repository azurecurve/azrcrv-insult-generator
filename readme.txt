...
### [Version 1.2.7](https://github.com/azurecurve/azrcrv-insult-generator/releases/tag/v1.2.7)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 1.2.6](https://github.com/azurecurve/azrcrv-insult-generator/releases/tag/v1.2.6)
 * Update plugin header and readme for compatibility with ClassicPress Directory v2.
 * Update Update Manager to version 2.5.0.
 
### [Version 1.2.5](https://github.com/azurecurve/azrcrv-insult-generator/releases/tag/v1.2.5)
 * Update readme file for compatibility with ClassicPress Directory.
 
### [Version 1.2.4](https://github.com/azurecurve/azrcrv-insult-generator/releases/tag/v1.2.4)
 * Update readme files.
