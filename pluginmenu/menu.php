 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_ig')){
	function azrcrv_create_plugin_menu_ig(){
		azrcrv_create_plugin_menu_table_ig();
		azrcrv_populate_plugin_menu_table_ig();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_ig')){
	function azrcrv_populate_plugin_menu_table_ig(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_ig')){
	function azrcrv_create_plugin_menu_table_ig(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
